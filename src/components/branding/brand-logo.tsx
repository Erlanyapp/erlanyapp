...
export function BrandLogo({ variant = "dark" }: BrandLogoProps) {
  ...
  if (variant === "gold") return <span className="brand-logo brand-logo-gold brand-logo-official"><Image src="/assets/erlany-fit-login-logo.png" alt="ERLANY FIT" width={150} height={150} priority /></span>;
