...
export type AdminWorkout={id:string;name:string;description:string|null;category:string|null;level:string|null;durationMinutes:number|null;scope:ContentScope;clientId:string|null;status:WorkoutStatus;isActive:boolean;exerciseCount:number;createdAt:string;updatedAt:string};
